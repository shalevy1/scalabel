...
describe('full 2d bounding box integration test', () => {
  ...
  test('test 2d-bounding-box annotation and save to disc', async () => {
    ...
    await page.goto('http://localhost:8687')
    await page.screenshot({ path: '/Users/beomjin_lee/Desktop/mouse_click.png' })
    // actual test
    await page.mouse.click(400, 250, { button: 'left' })
    await page.screenshot({ path: '/Users/beomjin_lee/Desktop/mouse_click2.png' })
    await browser.close()
